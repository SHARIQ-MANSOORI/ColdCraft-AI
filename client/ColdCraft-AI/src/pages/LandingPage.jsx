  ...
  const features = [
    {
      ...
      description:'Generate high-quality content in seconds with our advanced AI algorithms.',
      icon: BoltIcon,
    },

    {
      name:'Omni-Channel Support',
      description:'Get an email, a follow-up , and a LinkedIn Dm perfectly synced.',
      icon: DocumentTextIcon,

    },
    {
      name:'Higher Conversion Rates',
      description:'Personalized copy enures higher open rates and better reply outcomes',
      icon:ChartBarIcon
    }
  ]
    return (
